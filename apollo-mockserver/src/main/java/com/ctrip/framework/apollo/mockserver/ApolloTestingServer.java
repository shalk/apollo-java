...
public class ApolloTestingServer implements AutoCloseable {
  ...
  static {
    try {
      ...
      CONFIG_SERVICE_LOCATOR_CLEAR =
          ConfigServiceLocator.class.getDeclaredMethod("initConfigServices");
      ...
      RESOURCES_UTILS_CLEAR = ResourceUtils.class.getDeclaredMethod(
          "loadConfigFileFromDefaultSearchLocations", new Class[] {String.class});
  ...
  private String loadConfigFor(String appId, String namespace) {
    ...
    Map<String, String> mergedConfigurations =
        mergeOverriddenProperties(appId, namespace, configurations);
  ...
  private String mockLongPollBody(String notificationsStr) {
    List<ApolloConfigNotification> oldNotifications =
        GSON.fromJson(notificationsStr, notificationType);
  ...
  public void addOrModifyProperty(String appId, String namespace, String someKey,
      String someValue) {
    Map<String, Map<String, String>> addedOrModifiedPropertiesOfNamespace =
        addedOrModifiedPropertiesOfAppAndNamespace.computeIfAbsent(appId,
            key -> Maps.newConcurrentMap());
  ...
  private static void prepareLongPollingService() throws Exception {
    ...
    AtomicBoolean stopped =
        (AtomicBoolean) getLongPollField(longPollService, "m_longPollingStopped");
    stopped.set(false);
  }

  @SuppressWarnings("unchecked")
  private static void clearLongPollingState(RemoteConfigLongPollService longPollService)
      throws Exception {
  ...
  private static Object getLongPollField(RemoteConfigLongPollService longPollService,
